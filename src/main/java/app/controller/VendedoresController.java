...
public class VendedoresController {
	...
	public ResponseEntity<String>update (@RequestBody Vendedores vendedores, @PathVariable Long idVendedor ){
		try {
			String mensagem = this.vendedoresservice.update(idVendedor, vendedores);
			return new ResponseEntity<String>(mensagem,HttpStatus.OK);
		} catch (Exception e) {
	...
	@GetMapping("/listAll")
	public ResponseEntity<List<Vendedores>>listAll(){
		try {
			List<Vendedores> lista = this.vendedoresservice.listAll();
